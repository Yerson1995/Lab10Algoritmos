...
# reported EPS.  
    ...
    """positive_sentiment_pct_win=positive_sentiment_pct_win.winsorize(
        min_percentile=0.05,
        max_percentile=0.95
        )"""
    # Here we combine our winsorized factors, z-scoring them to equalize their influence
    combined_factor = (
         sentiment_score_winsorized.zscore()*1.10+                   value_winsorized*1.12+                            quality_winsorized*1.22+                    dollar_volume.zscore()*1.25+                recent_returns.zscore()*1.21+                                    positive_sentiment_pct*1.1#+cash*1.1   
    )
